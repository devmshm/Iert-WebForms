<%@ Page Language="C#" AutoEventWireup="true" CodeFile="marksallot.aspx.cs" Inherits="marksallot" %>
...
<body>
            ...
            <table id="tblgetlist" class="table table-bordered table-hover" width="100%">
                <thead class="report-header" style="font-weight: bold; text-align: center;">
                    <tr>
                        ...
                        <td style="font-size:18px;vertical-align:middle">Graduate<br /> (15)</td>
                        <td style="font-size:18px;vertical-align:middle">Post Graduate <br />(15)</td>
                        <td style="font-size:18px;vertical-align:middle">Sports & Games<br /> (15)</td>
                        <td style="font-size:18px;vertical-align:middle">Any Other Activity<br /> (15)</td>
                        <td style="font-size:18px;vertical-align:middle">Interview<br /> (40)</td>
                        <td style="font-size:18px;vertical-align:middle">Grand Total <br />(100)</td>
                        <td style="font-size:18px;vertical-align:middle;width:300px">Sign. of board members</td>
                    </tr>
                </thead>
    ...
    <script src="data_script/marks.js"></script>
</body>
</html>
