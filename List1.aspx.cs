                ...
                using (SqlDataAdapter adp = new SqlDataAdapter(cmd))
                {
                    ...
                    foreach (DataRow dr in Dt.Rows)
                    {
                        ...
                        sbTableHeader.AppendLine("<tr><td style=\"text-align:left;font-size:12px;\" colspan=\"7\">" +
                            ...
                            "<td style=\"border-bottom: solid 1px #000; vertical-align: middle; font-weight: bold; border-top: none; border-right: solid 1px #000;width:200px\">Name</td>" +
                            "<td style=\"border-bottom: solid 1px #000; vertical-align: middle; font-weight: bold; border-top: none; border-right: solid 1px #000;width:200px\">Father Name</td>" +
                            "<td style=\"border-bottom: solid 1px #000; vertical-align: middle; font-weight: bold; border-top: none; border-right: solid 1px #000\">Category</td>" +
                            "<td style=\"border-bottom: solid 1px #000; vertical-align: middle; font-weight: bold; border-top: none; border-right: solid 1px #000\">Sub Category</td>" +
                            "<td style=\"border-bottom: solid 1px #000; vertical-align: middle; font-weight: bold; border-top: none; border-right: solid 1px #000\">EWS</td>" +
                            "<td style=\"border-bottom: solid 1px #000; vertical-align: middle; font-weight: bold; border-top: none; border-right: solid 1px #000\">DOB</td>" +
                            "<td style=\"border-bottom: solid 1px #000; vertical-align: middle; font-weight: bold; border-top: none; border-right: solid 1px #000\">GENDER</td>" +
                            "<td style=\"border-bottom: solid 1px #000; vertical-align: middle; font-weight: bold; border-top: none;;width:200px\">MERIT</td></tr> ");
                        sbTableHeader.AppendLine("</thead>");
