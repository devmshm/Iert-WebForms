<%@ Page Language="C#" AutoEventWireup="true" CodeFile="interviewlist.aspx.cs" Inherits="interviewlist" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            <asp:Repeater runat="server" ID="gdvlist">
                ...
                <ItemTemplate>
                    <%# (Container.ItemIndex ) % 10 == 0? TableHeader : "" %>
                    ...
                    <tr style="font-size:12px;">
                        ...
                        <td style="border-bottom: solid 1px #000; vertical-align: top; border-top: none; border-right: solid 1px #000">
