<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/masterpages/Admin.master" CodeFile="report2.aspx.cs" Inherits="report2" %>
                ...
                success: function (Result) {
                    ...
                    if (Result.length > 0) {
                        ...
                        $.each(Result, function (key, value) {
                            ...
                            $('#tbllist tbody').append(' <tr style="text-align:center"><td>' + (key + 1) + '</td><td>' + value.COURSE + '</td><td>' + value.TOTAL + '</td><td>' + value.BASIC_UPDATED + '</td><td>' + value.ADDRESS_UPDATED + '</td><td>' + value.EDU_UPDATED + '</td><td>' + value.PHOTO_UPDATED + '</td><td>' + value.SIGN_UPDATED + '</td><td>' + value.THUMB_UPDATED + '</td><td>' + value.PAYMENTSTATUS + '</td><td>' + value.SUBMIT + '</td></tr></tbody></tbody>');
