<%@ Page Language="C#" AutoEventWireup="true" CodeFile="paylog.aspx.cs" Inherits="paylog" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <br />
        <div class="alert alert-danger" id="dvmessage" runat="server"></div>
        <div class="container">
                ...
                <div class="card-body" style="font-size: 16px">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <asp:TextBox ID="txtroll" Font-Size="16px" runat="server"  CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <asp:TextBox ID="txtname" Font-Size="16px" runat="server"  CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                ...
                <div class="panel-heading" style="height: 50px">
                    <div class="form-group">
                        <div class="col-md-12" style="font-size: 16px">
                            <asp:Button CssClass="btn btn-danger pull-right" Font-Size="16px" runat="server" ID="btnlog" Text="Proceed" OnClick="btnlog_Click" />
                        </div>
                    </div>
                </div>
            </div>
