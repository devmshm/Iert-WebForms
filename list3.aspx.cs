                ...
                using (SqlDataAdapter adp = new SqlDataAdapter(cmd))
                {
                    ...
                    foreach (DataRow dr in Dt.Rows)
                    {
                        ...
                        sbTableHeader.AppendLine("<tr><td style=\"text-align:center; font-weight:bold; font-size:14px;\" colspan=\"11\"> " +
                            ...
                            "INSTITUTE OF ENGINEERING AND RURAL TECHNOLOGY,ALLAHABAD <br>" + dr["COURSE"].ToString().ToUpper() + " <br> ATTENDANCE SHEET FOR PROVISIONAL ADMISSION  IN &nbsp;" + dr["Course"].ToString().ToUpper() + " </td>");
                        ...
                        sbTableHeader.AppendLine("<tr><td style=\"text-align:left;font-size:12px;\" colspan=\"7\">" +
                            ...
                            "<td style=\"border-bottom: solid 1px #000; vertical-align: middle; font-weight: bold; border-top: none; border-right: solid 1px #000\">Candidate's Sign & Thumb</td>" +
                            "<td style=\"border-bottom: solid 1px #000; vertical-align: middle; font-weight: bold; border-top: none; border-right: solid 1px #000\">Date & Time of Reporting</td>" +
                            "<td style=\"border-bottom: solid 1px #000; vertical-align: middle; font-weight: bold; border-top: none;\">Signature of Reported Candidate</td></tr>");
                        sbTableHeader.AppendLine("</thead>");
