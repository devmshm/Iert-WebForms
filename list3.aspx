            ...
            <asp:Repeater runat="server" ID="gdvlist">
                ...
                <ItemTemplate>
                    ...
                    <tr style="font-size: 12px;">
                        ...
                        <td style="border-bottom: solid 1px #000; vertical-align: middle; border-top: none; border-right: solid 1px #000">
                            <tb>
                                <img src="http://iertentrance.in/photo/<%#DataBinder.Eval(Container.DataItem, "candidate_sign")%>" style="height: 50px; width: 90px" /></tb>
                            <tb>
                                <img src="http://iertentrance.in/photo/<%#DataBinder.Eval(Container.DataItem, "candidate_thumb")%>" style="height: 50px; width: 90px" /></tb>
                        </td>
                        <td style="border-bottom: solid 1px #000; vertical-align: middle; border-top: none; border-right: solid 1px #000">&nbsp;
                        </td>
