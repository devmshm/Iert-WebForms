<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/masterpages/home.master" MaintainScrollPositionOnPostback="true" CodeFile="counselling.aspx.cs" Inherits="counselling" %>
            ...
            <div class="calltoaction-20-content row ">
                <div class="col-md-12 col-sm-12 row justify-content-center">
                    <form id="frm1" runat="server">
                        ...
                        <hr />
                        <div class="col-md-12 col-sm-12 row justify-content-center"><span id="dverror" runat="server" class="alert alert-danger"></span></div>
