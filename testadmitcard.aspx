<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/masterpages/candidate.master" CodeFile="testadmitcard.aspx.cs" Inherits="testadmitcard" %>
        ...
        $(function () {
            $(document).ready(function () {
                let finalURL =
                    ...
                    htmlEncode('https://iertentrance.in/admitcard.aspx?application_no=' + $('#txtapplno').html()) +
